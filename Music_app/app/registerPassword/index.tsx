...
const RegisterPassword = () => {
    ...
    return (
        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
            ...
            <View>
                <Text style={{fontWeight: 'bold', fontSize: 18, color: 'white'}}>Re-enter your password</Text>
            </View>
            <View style={{alignItems: 'center'}}>
                <Input
                    placeholder="Re-enter your password"
                    placeholderTextColor={'#BFC4C1'}
                    inputStyle={{borderWidth: 1, borderRadius: 5, height: 50, padding: 10, borderColor: 'white', color: 'white'}}
