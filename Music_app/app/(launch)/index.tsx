    ...
    return (
        <View style={{flex: 1, justifyContent: 'space-between', alignItems: 'center', }}>
            ...
            <View style={{width: 250, paddingTop: 100}}>
                <Text style={{fontSize: 50, color: 'white', fontWeight: 'bold', alignSelf: 'center'}}>
            ...
            <View style={{marginBottom: 50, gap: 20}}>
                <Button
                    ...
                    buttonStyle={{backgroundColor: 'black', width: 300, height: 50, borderRadius: 25}}
                    onPress={() => router.push("signup")}
                />
                <Button
                    title="I already have an account"
                    titleStyle={{fontWeight: 'bold', fontSize: 20, color: '#16C3D9'}}
                    buttonStyle={{backgroundColor: 'white', width: 300, height: 50, borderRadius: 25}}
